...
public class UserHandler extends ChatHttpHandler {
    public static final String CONTEXT_LOGIN = "/login";

    public UserHandler(ChatServer chatServer) {
        super(chatServer);
    }
        ...
        try {
            ...
            case METHOD_POST:
                ...
                try {
                    ...
                    String password = objectRequest.get("password");
                    boolean isUser = chatServer.isUser(username, password);
                    if (isUser) {
